...
const Home = () => {
  async function handleClick(type) {
    const recipes = (await axios.get(`http://localhost:5001/home/${type}`))
      .data;
    console.log(recipes);
  }
  ...
  return (
    <Box sx={{ flexGrow: 1, p: 2 }}>
        ...
        >
          <CardContent>
            ...
            <Typography
              ...
              sx={{ mt: 2 }}
            >
              Start exploring recipes today! Search user generated ones or even
              create your own!
            </Typography>
            <Button
              variant="contained"
      ...
      <Card
        className="homeLongBanner"
        sx={{
          display: "flex",
          width: "100%",
          mb: 4,
          p: 2,
          borderLeft: "20px solid #2e6123",
        }}
      >
        <Grid container>
          <Grid
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            ...
            <CardContent>
              ...
              <Button
                variant="outlined"
                sx={{ mt: 2, borderColor: "#2e6123", color: "#2e6123" }}
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Struggling with Keto diet restrictions? Explore our array of
                options!
              </Typography>
              <Button
                variant="outlined"
                sx={{ mt: 2, borderColor: "#2e6123", color: "#2e6123" }}
                onClick={() => handleClick("keto")}
              >
                View Recipes
              </Button>
            </CardContent>
      ...
      <Box
        sx={{
          ...
          height: "30vh",
          backgroundImage:
            "url(https://www.finedininglovers.com/sites/g/files/xknfdk626/files/styles/article_1200_800_fallback/public/2022-11/Stanly%20Ranch%20%289%29.jpg?itok=yJb7-jgU)",
      ...
      >
        <Box
          sx={{
            ...
            width: "100%",
            height: "100%",
            backgroundColor: "rgba(46, 97, 35, 0.6)",
            display: "flex",
            justifyContent: "center",
            alignItems: "center",
          }}
