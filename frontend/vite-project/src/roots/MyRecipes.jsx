...
const MyRecipes = () => {
  ...
  const yourRecipes = [
    { id: 1, title: 'Your Recipe 1', description: 'Description for Your Recipe 1', cuisineType: 'American', mealType: 'Breakfast', imageUrl: 'https://images.everydayhealth.com/images/diet-nutrition/what-is-a-vegan-diet-benefits-food-list-beginners-guide-alt-1440x810.jpg?sfvrsn=1d260c85_1' },
    { id: 2, title: 'Your Recipe 2', description: 'Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 Description for Your Recipe 2 v', cuisineType: 'Italian', mealType: 'Lunch/Dinner', imageUrl: 'https://images.everydayhealth.com/images/diet-nutrition/what-is-a-vegan-diet-benefits-food-list-beginners-guide-alt-1440x810.jpg?sfvrsn=1d260c85_1' },
  ];
            ...
            <Card className="recipe-card" onClick={() => handleOpenRecipe(recipe.id)}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  {recipe.description.length > 40 ? `${recipe.description.substring(0, 40)}...` : recipe.description}
                </Typography>
